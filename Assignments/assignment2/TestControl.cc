...
void TestControl::clientTest(){
    ...
    cout<<"Playing podcast "<<titles[1]<<" Episode 2 locally for subscriber "<<subs[2]<<endl;
...
/******   To test the Client::stream function
    cout<<"Attempt to stream "<<titles[1]<<" remotely - should NOT play"<<endl;
    client->stream(network, titles[1], 1);

    cout<<"Attempt to stream "<<titles[0]<<" remotely - should play"<<endl;
    client->stream(network, titles[0], 1);
    */
